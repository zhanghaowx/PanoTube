define(["lib/three"], function() {
     ...
     * @author hao
     */
    THREE.PanoramaCubeGeometry = function ( width, height, depth, widthSegments, heightSegments, depthSegments ) {
    ...
    THREE.PanoramaCubeGeometry.prototype = Object.create( THREE.Geometry.prototype );
});
